...
for sd in xrange(1001,1015):
    ...
    for fn in FL:
        ...
        if True:
            ...
            mdldir = resdir + "/%s_NDMI_IV%dP_SD%d"%(mch_id,per_faults,sd)
            ...
            cmd_list.append("python src/python/make_faulty_machine_NDMI.py %s %d %d %s/faulty_model"%(mchfile,per_faults,sd,mdldir))
