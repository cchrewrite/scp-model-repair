...
# Output - 
# Usage: python [this script] [source abstract machine] [number of goal states] [reachability depth] [seed] [result folder]
...
for G in LGS:
    ...
    print "====== D = D - LDT ======"
    PD = 0.1 + random.random() * 0.15 #0.9
    X = Bmch.deleted_partial_transitions(D,G,PD,RD)
    D = X[0]
    LDT = X[1]
