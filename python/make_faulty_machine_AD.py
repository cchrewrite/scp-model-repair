...
# It makes a faulty B machines by randomly changing current transitions to faulty transitions / adding faulty transitions (50% vs 50%). Only deterministic transitions are made.
