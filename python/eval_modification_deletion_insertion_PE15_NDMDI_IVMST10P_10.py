...
for sd in xrange(1001,1011):
    ...
    for fn in FL:
        ...
        for sem_mdl_type in ["MLP4L","MLPAE4L","FNNRBB16L","SKCART","Random"]: #["SKCART"]: #["SKCART","Silas","BNBayes","LR","SVM","MLP"]:
        #for sem_mdl_type in ["Random","BNBayes","LR","SVM"]:
            ...
            #cmd_list.append("python src/python/b_model_evaluation.py %s/goal_reachability_repair/source.mch %s/eval.data %s %s/faulty_model"%(rprdir,mdldir,conffile,evaldir))
